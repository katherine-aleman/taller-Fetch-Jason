...
fetch(DATA_URL)
  ...
  .then(data => showData(data.students)) // Llamamos a showData con los estudiantes
  .catch(error => console.error("Error al cargar los datos:", error)); // Manejamos los errores